...
CREATE TABLE IF NOT EXISTS tblMain (ID int AUTO_INCREMENT NOT NULL, entryTitle varchar(100) NOT NULL, entryDate DATE, usedTemplateID int NOT NULL, entryTEXT TEXT NOT NULL, CONSTRAINT mainPrimKey PRIMARY KEY (ID));
CREATE INDEX entryTitleIndex ON tblMain(entryTitle);

/*CREATE TABLE IF NOT EXISTS tblEntryTemplateRelation (mainEntryID int, templateEntryID int, CONSTRAINT entryRelationPrimKey PRIMARY KEY(mainEntryID, templateEntryID));*/
